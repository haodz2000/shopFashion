                                ...
                                while ($product<4)
                            {
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="products">
                                        ...
                                        <div class="thumbnail"><a href="{{route('product-detail')}}"><img src="images/products/small/{{$pro[$i*4 + $product]->images}}" alt="Product Name"></a></div>
                                        <div class="productname">{{$pro[$i*4 + $product]->name}}</div>
                                        <h4 class="price">{{$pro[$i*4 + $product]->price}}</h4>
                                        <div class="button_group">
                                            <button type="button" data-id="{{$pro[$i*4 + $product]->id}}" class="button add-cart"  >Add To Cart</button>
                            ...
                            while ($product<4)
                            {
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="products">
                                        ...
                                        <h4 class="price">{{$pro[$i*4 + $product]->price}}</h4>
                                        <div class="button_group">
                                            <button class="button add-cart" data-id="{{$pro[$i*4 + $product]->id}}" type="button add-cart">Add To Cart</button>
